...
export class TaskItemServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TaskItemDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<TaskItemDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TaskItemDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<TaskItemDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TaskItemDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    create(body: CreateTaskItemDto | undefined): Observable<TaskItemDto> {
     ...
     * @return Success
     */
    update(body: TaskItemDto | undefined): Observable<TaskItemDto> {
...
export class CreateTaskItemDto implements ICreateTaskItemDto {
    id: string;
    ...
    constructor(data?: ICreateTaskItemDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateTaskItemDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTaskItemDto();
        result.init(data);
        return result;
    }
...
export interface ICreateTaskItemDto {
    id: string;
    title: string | undefined;
    description: string | undefined;
    taskStatusId: number;
...
export class TaskItemDtoPagedResultDto implements ITaskItemDtoPagedResultDto {
    items: TaskItemDto[] | undefined;
    totalCount: number;

    constructor(data?: ITaskItemDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TaskItemDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new TaskItemDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): TaskItemDtoPagedResultDto {
        const json = this.toJSON();
        let result = new TaskItemDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ITaskItemDtoPagedResultDto {
    items: TaskItemDto[] | undefined;
    totalCount: number;
}
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["tasks"])) {
                ...
                for (let item of _data["tasks"])
                    this.tasks.push(TaskItem.fromJS(item));
            }
        }
    }
