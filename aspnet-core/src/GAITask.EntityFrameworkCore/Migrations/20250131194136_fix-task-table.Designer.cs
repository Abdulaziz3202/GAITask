...
namespace GAITask.Migrations
{
    ...
    [Migration("20250131194136_fix-task-table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GAITask.ProjectEntities.TaskItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GAITask.ProjectEntities.TaskStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("GAITask.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("GAITask.Authorization.Users.User", null)
                        .WithMany("Claims")
