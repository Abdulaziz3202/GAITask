...
{
    public abstract class GAITaskWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GAITaskWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GAITaskWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GAITaskDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GAITaskDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GAITaskDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GAITaskDbContext, Task<T>> func)
        {
            T result;
